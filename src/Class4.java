public class Class4 implements Interface2 {
	...
	static final void method88(final boolean bool_0) {
		...
		for (int_0 = 0; int_0 < Client.pendingNpcFlagsCount; int_0++) {
			...
			if ((int_2 & 0x8) != 0) {
				int_3 = Client.secretPacketBuffer2.readUShortLE();
				int_4 = Client.secretPacketBuffer2.readUShortLE();
			...
			if ((int_2 & 0x4) != 0) {
				npc_0.graphic = Client.secretPacketBuffer2.readUShortLE();
			...
			if ((int_2 & 0x2) != 0) {
				npc_0.composition = Class81.getNpcDefinition(Client.secretPacketBuffer2.readUShortLE());
