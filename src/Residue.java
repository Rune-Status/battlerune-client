public class Residue {
	...
	Residue() {
		type = Node_Sub2.getInt(16);
		begin = Node_Sub2.getInt(24);
		end = Node_Sub2.getInt(24);
		partitionSize = Node_Sub2.getInt(24) + 1;
		classification = Node_Sub2.getInt(6) + 1;
		classBook = Node_Sub2.getInt(8);
		final int[] ints_0 = new int[classification];

		int int_0;
		for (int_0 = 0; int_0 < classification; int_0++) {
			int int_1 = 0;
			final int int_2 = Node_Sub2.getInt(3);
		...
		anIntArray67 = new int[classification * 8];

		for (int_0 = 0; int_0 < (classification * 8); int_0++) {
			anIntArray67[int_0] = (ints_0[int_0 >> 3] & (1 << (int_0 & 0x7))) != 0 ? Node_Sub2.getInt(8) : -1;
		}
			...
			for (int int_4 = 0; int_4 < 8; int_4++) {
				...
				while (int_5 < int_3) {
					...
					for (int_6 = 0; int_6 < int_1; int_6++) {
						int_7 = ints_0[int_5];
						final int int_8 = anIntArray67[int_4 + (int_7 * 8)];
						if (int_8 >= 0) {
							...
							if (type == 0) {
								...
								for (int int_11 = 0; int_11 < int_10; int_11++) {
									final float[] floats_1 = codebook_0.method316();
								...
								while (int_10 < partitionSize) {
									final float[] floats_2 = codebook_0.method316();
