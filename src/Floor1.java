public class Floor1 {
	...
	static {
		...
		aFloatArray1 = new float[] { 1.0649863E-7F, 1.1341951E-7F, 1.2079015E-7F, 1.2863978E-7F, 1.369995E-7F,
	...
	Floor1() {
		final int int_0 = Node_Sub2.getInt(16);
		if (int_0 != 1) {
			throw new RuntimeException();
		} else {
			final int int_1 = Node_Sub2.getInt(5);
			int int_2 = 0;
			...
			for (int_3 = 0; int_3 < int_2; int_3++) {
				classDimensions[int_3] = Node_Sub2.getInt(3) + 1;
				int_4 = classSubClasses[int_3] = Node_Sub2.getInt(2);
				if (int_4 != 0) {
					classMasterbooks[int_3] = Node_Sub2.getInt(8);
				}
			...
			multiplier = Node_Sub2.getInt(2) + 1;
			...
			anIntArray11 = new int[int_4];
			anIntArray11[0] = 0;
			anIntArray11[1] = 1 << int_3;
			int_4 = 2;
			...
			for (int_6 = 0; int_6 < int_1; int_6++) {
				...
				for (int int_7 = 0; int_7 < classDimensions[int_5]; int_7++) {
					anIntArray11[int_4++] = Node_Sub2.getInt(int_3);
				}
			}
	...
	void method220(final int int_0, final int int_1) {
		if (int_0 < int_1) {
			int int_2 = int_0;
			...
			method220(int_0, int_2 - 1);
			method220(int_2 + 1, int_1);
		}
	}

	void method221(final int int_0, final int int_1, int int_2, final int int_3, final float[] floats_0,
			final int int_4) {
	...
	int method222(final int int_0, final int int_1, final int int_2, final int int_3, final int int_4) {
		final int int_5 = int_3 - int_1;
		final int int_6 = int_2 - int_0;
	...
	boolean decodedFloor() {
		...
		if (!bool_0) {
			...
			final int int_0 = anIntArray11.length;

			int int_1;
			for (int_1 = 0; int_1 < int_0; int_1++) {
				xList[int_1] = anIntArray11[int_1];
			}

			int_1 = RANGES[multiplier - 1];
			final int int_2 = Class84.ilog(int_1 - 1);
	...
	void computeFloor(final float[] floats_0, final int int_0) {
		final int int_1 = anIntArray11.length;
		...
		for (int_3 = 2; int_3 < int_1; int_3++) {
			int_4 = method223(xList, int_3);
			int_5 = method224(xList, int_3);
			int_6 = method222(xList[int_4], yList[int_4], xList[int_5], yList[int_5], xList[int_3]);
			int_7 = yList[int_3];
			...
			if (int_7 != 0) {
				...
				if (int_7 >= int_9) {
					...
					yList[int_3] = (int_7 & 0x1) != 0 ? int_6 - ((int_7 + 1) / 2) : int_6 + (int_7 / 2);
				}
			} else {
		...
		for (int_5 = 1; int_5 < int_1; int_5++) {
			if (aBoolArray1[int_5]) {
				...
				method221(int_3, int_4, int_6, int_7, floats_0, int_0);
				if (int_6 >= int_0) {
					return;
				}
		...
		final float float_0 = aFloatArray1[int_4];
	...
	static int method223(final int[] ints_0, final int int_0) {
	...
	static int method224(final int[] ints_0, final int int_0) {
		final int int_1 = ints_0[int_0];
		int int_2 = -1;
