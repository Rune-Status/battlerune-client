public final class Class64 {
	...
	public static int method388(final byte[] bytes_0, int int_0, final byte[] bytes_1, final int int_1,
			final int int_2) {
		synchronized (state) {
			state.strm = bytes_1;
			state.next_in = int_2;
	...
	static void method389(final DState dstate_0) {
		int int_0 = 0;
		int[] ints_0 = null;
		int[] ints_1 = null;
		int[] ints_2 = null;
		dstate_0.blockSize100k = 1;
		if (NPC.anIntArray141 == null) {
			NPC.anIntArray141 = new int[dstate_0.blockSize100k * 100000];
		}
		...
		while (true) {
			while (bool_18) {
				byte byte_0 = method390(dstate_0);
				if (byte_0 == 23) {
					return;
				}

				byte_0 = method390(dstate_0);
				byte_0 = method390(dstate_0);
				byte_0 = method390(dstate_0);
				byte_0 = method390(dstate_0);
				byte_0 = method390(dstate_0);
				...
				final int int_11 = method391(3, dstate_0);
				final int int_12 = method391(15, dstate_0);
				...
				for (int_7 = 0; int_7 < int_12; int_7++) {
					...
					while (true) {
						byte_0 = method392(dstate_0);
						if (byte_0 == 0) {
							dstate_0.aByteArray8[int_7] = (byte) int_8;
							break;
						}
				...
				for (int_7 = 0; int_7 < int_12; int_7++) {
					byte_1 = dstate_0.aByteArray8[int_7];
					...
					bytes_0[0] = byte_2;
					dstate_0.aByteArray7[int_7] = byte_2;
				}

				int int_9;
				for (int_9 = 0; int_9 < int_11; int_9++) {
					int int_20 = method391(5, dstate_0);
				...
				for (int_9 = 0; int_9 < int_11; int_9++) {
					...
					method394(dstate_0.anIntArrayArray6[int_9], dstate_0.anIntArrayArray7[int_9],
							dstate_0.anIntArrayArray8[int_9], dstate_0.aByteArrayArray3[int_9], byte_3, byte_4, int_10);
				...
				for (int_1 = 15; int_1 >= 0; --int_1) {
					for (int_24 = 15; int_24 >= 0; --int_24) {
						dstate_0.aByteArray6[int_23] = (byte) (int_24 + (int_1 * 16));
						--int_23;
					}
				...
				if (byte_5 == 0) {
					++int_14;
					byte_5 = 50;
					byte_7 = dstate_0.aByteArray7[int_14];
				...
				int int_22;
				byte byte_6;
				for (int_22 = method391(int_0, dstate_0); int_22 > ints_0[int_21]; int_22 = (int_22 << 1) | byte_6) {
					++int_21;
					byte_6 = method392(dstate_0);
				}
				...
				while (true) {
					while (int_16 != int_13) {
						if ((int_16 != 0) && (int_16 != 1)) {
							...
							if (int_2 < 16) {
								...
								for (byte_0 = dstate_0.aByteArray6[int_3 + int_2]; int_2 > 3; int_2 -= 4) {
									final int int_4 = int_3 + int_2;
									dstate_0.aByteArray6[int_4] = dstate_0.aByteArray6[int_4 - 1];
									dstate_0.aByteArray6[int_4 - 1] = dstate_0.aByteArray6[int_4 - 2];
									dstate_0.aByteArray6[int_4 - 2] = dstate_0.aByteArray6[int_4 - 3];
									dstate_0.aByteArray6[int_4 - 3] = dstate_0.aByteArray6[int_4 - 4];
								}

								while (int_2 > 0) {
									dstate_0.aByteArray6[int_3 + int_2] = dstate_0.aByteArray6[(int_3 + int_2) - 1];
									--int_2;
								}

								dstate_0.aByteArray6[int_3] = byte_0;
							} else {
								int int_5 = int_2 / 16;
								final int int_6 = int_2 % 16;
								int_3 = dstate_0.anIntArray27[int_5] + int_6;

								for (byte_0 = dstate_0.aByteArray6[int_3]; int_3 > dstate_0.anIntArray27[int_5]; --int_3) {
									dstate_0.aByteArray6[int_3] = dstate_0.aByteArray6[int_3 - 1];
								}
								...
								while (int_5 > 0) {
									--dstate_0.anIntArray27[int_5];
									dstate_0.aByteArray6[dstate_0.anIntArray27[int_5]] = dstate_0.aByteArray6[(dstate_0.anIntArray27[int_5
											- 1] + 16) - 1];
									--int_5;
								}

								--dstate_0.anIntArray27[0];
								dstate_0.aByteArray6[dstate_0.anIntArray27[0]] = byte_0;
								if (dstate_0.anIntArray27[0] == 0) {
									int_23 = 4095;

									for (int_1 = 15; int_1 >= 0; --int_1) {
										for (int_24 = 15; int_24 >= 0; --int_24) {
											dstate_0.aByteArray6[int_23] = dstate_0.aByteArray6[dstate_0.anIntArray27[int_1]
													+ int_24];
											--int_23;
										}
							...
							NPC.anIntArray141[int_17] = dstate_0.seqToUnseq[byte_0 & 0xFF] & 0xFF;
							++int_17;
							if (int_15 == 0) {
								++int_14;
								int_15 = 50;
							...
							for (int_22 = method391(int_0, dstate_0); int_22 > ints_0[int_21]; int_22 = (int_22 << 1)
									| byte_6) {
								++int_21;
								byte_6 = method392(dstate_0);
							}
							...
							++int_18;
							byte_0 = dstate_0.seqToUnseq[dstate_0.aByteArray6[dstate_0.anIntArray27[0]] & 0xFF];

							for (dstate_0.anIntArray25[byte_0 & 0xFF] += int_18; int_18 > 0; --int_18) {
								NPC.anIntArray141[int_17] = byte_0 & 0xFF;
								++int_17;
							}
						}
					}
					...
					for (int_7 = 0; int_7 < int_17; int_7++) {
						byte_0 = (byte) (NPC.anIntArray141[int_7] & 0xFF);
						NPC.anIntArray141[dstate_0.anIntArray26[byte_0 & 0xFF]] |= int_7 << 8;
						++dstate_0.anIntArray26[byte_0 & 0xFF];
					}

					dstate_0.tPos = NPC.anIntArray141[dstate_0.anInt121] >> 8;
					dstate_0.nblock_used = 0;
					dstate_0.tPos = NPC.anIntArray141[dstate_0.tPos];
					dstate_0.anInt122 = (byte) (dstate_0.tPos & 0xFF);
					dstate_0.tPos >>= 8;
					++dstate_0.nblock_used;
					dstate_0.anInt123 = int_17;
					method395(dstate_0);
					if (((dstate_0.anInt123 + 1) == dstate_0.nblock_used) && (dstate_0.out_len == 0)) {
						bool_18 = true;
						break;
					}
	...
	static byte method390(final DState dstate_0) {
		return (byte) method391(8, dstate_0);
	}

	static int method391(final int int_0, final DState dstate_0) {
	...
	static byte method392(final DState dstate_0) {
		return (byte) method391(1, dstate_0);
	}

	static void method393(final DState dstate_0) {
		dstate_0.nInUse = 0;
	...
	static void method394(final int[] ints_0, final int[] ints_1, final int[] ints_2, final byte[] bytes_0,
	...
	static void method395(final DState dstate_0) {
		...
		dstate_0.anInt122 = int_2;
		NPC.anIntArray141 = ints_0;
		dstate_0.tPos = int_3;
