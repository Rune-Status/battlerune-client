public class Track1 extends Node {
	...
	Track1(final Buffer buffer_0) {
		...
		int_12 = int_7 + int_4 + int_0 + int_3 + int_5 + int_6 + int_8 + int_9 + int_10;
		...
		buffer_0.offset += int_9 + int_5 + int_6;
		...
		aByteArray18 = new byte[int_2];
		final Buffer buffer_1 = new Buffer(aByteArray18);
		...
		label222: for (int int_56 = 0; int_56 < int_0; int_56++) {
	...
	void method684() {
		if (aXHashTable7 == null) {
			aXHashTable7 = new XHashTable(16);
			final int[] ints_0 = new int[16];
			final int[] ints_1 = new int[16];
			ints_1[9] = 128;
			ints_0[9] = 128;
			final Class69 class69_0 = new Class69(aByteArray18);
			final int int_0 = class69_0.method410();

			int int_1;
			for (int_1 = 0; int_1 < int_0; int_1++) {
				class69_0.method408(int_1);
				class69_0.method412(int_1);
				class69_0.method416(int_1);
			}

			label53: do {
				while (true) {
					int_1 = class69_0.method409();
					final int int_2 = class69_0.anIntArray43[int_1];

					while (int_2 == class69_0.anIntArray43[int_1]) {
						class69_0.method408(int_1);
						final int int_3 = class69_0.method411(int_1);
						if (int_3 == 1) {
							class69_0.method415();
							class69_0.method416(int_1);
							continue label53;
						...
						if (int_4 == 144) {
							...
							if (int_7 > 0) {
								...
								Node_Sub5 node_sub5_0 = (Node_Sub5) aXHashTable7.get(int_8);
								if (node_sub5_0 == null) {
									node_sub5_0 = new Node_Sub5(new byte[128]);
									aXHashTable7.put(node_sub5_0, int_8);
								}

								node_sub5_0.aByteArray14[int_6] = 1;
							}
						}
	...
	public static Track1 getMusicFile(final IndexDataBase indexdatabase_0, final int int_0, final int int_1) {
