	...
	final boolean processServerPacket() {
		if (Occluder.rssocket == null) {
			...
			try {
				...
				int int_3;
				if (packetType == 168) {
					int_1 = secretPacketBuffer2.readUByte();
					if (int_1 == 65535) {
						int_1 = -1;
					}
				...
				if (packetType == 177) {
					int_1 = secretPacketBuffer2.readIntLE();
					int_2 = secretPacketBuffer2.readUByte();
					int_3 = (int_2 >> 10) & 0x1F;
					int_4 = (int_2 >> 5) & 0x1F;
					int_5 = int_2 & 0x1F;
				...
				if ((packetType != 248) && (packetType != 214) && (packetType != 122) && (packetType != 102)
					...
					if (packetType == 57) {
						...
						int_3 = secretPacketBuffer2.readUByte();
						if (int_3 == 65535) {
							int_3 = -1;
						}
					...
					if (packetType == 94) {
						...
						for (int_5 = 0; int_5 < int_4; int_5++) {
							int_6 = secretPacketBuffer2.readUByte();
					...
					if (packetType != 121) {
						...
						if (packetType == 60) {
							...
							System.out.println("static region: " + int_1);
