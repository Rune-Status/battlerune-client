public final class Font extends FontTypeFace {
	...
	@Override
	final void renderRGB(final byte[] bytes_0, int int_0, int int_1, int int_2, int int_3, final int int_4) {
	...
	@Override
	final void renderRGBA(final byte[] bytes_0, int int_0, int int_1, int int_2, int int_3, final int int_4,
			final int int_5) {
