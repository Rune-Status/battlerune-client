public class ModelData extends Renderable {
	...
	static {
		...
		anInt609 = 0;
		anIntArray137 = Graphics3D.SINE;
		anIntArray139 = Graphics3D.COSINE;
	}
	...
	public ModelData(final ModelData[] modeldatas_0, final int int_0) {
		...
		if (anInt615 > 0) {
			textureRenderTypes = new byte[anInt615];
			texTriangleX = new short[anInt615];
			texTriangleY = new short[anInt615];
			texTriangleZ = new short[anInt615];
			aShortArray12 = new short[anInt615];
			aShortArray13 = new short[anInt615];
			aShortArray14 = new short[anInt615];
			aShortArray15 = new short[anInt615];
			aByteArray28 = new byte[anInt615];
			aShortArray16 = new short[anInt615];
			texturePrimaryColor = new short[anInt615];
		}
				...
				for (int_2 = 0; int_2 < modeldata_1.triangleFaceCount; int_2++) {
					...
					if (bool_5) {
						if ((modeldata_1.textureCoords != null) && (modeldata_1.textureCoords[int_2] != -1)) {
							textureCoords[triangleFaceCount] = (byte) (anInt615 + modeldata_1.textureCoords[int_2]);
						} else {
					...
					trianglePointsX[triangleFaceCount] = method994(modeldata_1, modeldata_1.trianglePointsX[int_2]);
					trianglePointsY[triangleFaceCount] = method994(modeldata_1, modeldata_1.trianglePointsY[int_2]);
					trianglePointsZ[triangleFaceCount] = method994(modeldata_1, modeldata_1.trianglePointsZ[int_2]);
					++triangleFaceCount;
				}

				for (int_2 = 0; int_2 < modeldata_1.anInt615; int_2++) {
					final byte byte_0 = textureRenderTypes[anInt615] = modeldata_1.textureRenderTypes[int_2];
					if (byte_0 == 0) {
						texTriangleX[anInt615] = (short) method994(modeldata_1, modeldata_1.texTriangleX[int_2]);
						texTriangleY[anInt615] = (short) method994(modeldata_1, modeldata_1.texTriangleY[int_2]);
						texTriangleZ[anInt615] = (short) method994(modeldata_1, modeldata_1.texTriangleZ[int_2]);
					}

					if ((byte_0 >= 1) && (byte_0 <= 3)) {
						texTriangleX[anInt615] = modeldata_1.texTriangleX[int_2];
						texTriangleY[anInt615] = modeldata_1.texTriangleY[int_2];
						texTriangleZ[anInt615] = modeldata_1.texTriangleZ[int_2];
						aShortArray12[anInt615] = modeldata_1.aShortArray12[int_2];
						aShortArray13[anInt615] = modeldata_1.aShortArray13[int_2];
						aShortArray14[anInt615] = modeldata_1.aShortArray14[int_2];
						aShortArray15[anInt615] = modeldata_1.aShortArray15[int_2];
						aByteArray28[anInt615] = modeldata_1.aByteArray28[int_2];
						aShortArray16[anInt615] = modeldata_1.aShortArray16[int_2];
					}

					if (byte_0 == 2) {
						texturePrimaryColor[anInt615] = modeldata_1.texturePrimaryColor[int_2];
					}
	...
	public void computeNormals() {
		if (normals == null) {
			...
			for (int_0 = 0; int_0 < triangleFaceCount; int_0++) {
				...
				int int_13 = (int) Math.sqrt((int_12 * int_12) + (int_10 * int_10) + (int_11 * int_11));
				if (int_13 <= 0) {
					int_13 = 1;
				}
				...
				if (byte_0 == 0) {
					...
					vertexnormal_0.anInt196 += int_10;
					vertexnormal_0.anInt197 += int_11;
					vertexnormal_0.anInt198 += int_12;
					...
					facenormal_0.anInt238 = int_10;
					facenormal_0.anInt237 = int_11;
					facenormal_0.anInt236 = int_12;
				}
			}
	...
	public void method985(final short short_0, final short short_1) {
	...
	void decodeOldFormat(final byte[] bytes_0) {
		...
		if (textureCoords != null) {
			...
			for (int_32 = 0; int_32 < int_1; int_32++) {
				...
				if (int_33 != 255) {
					if (((texTriangleX[int_33] & 0xFFFF) == trianglePointsX[int_32])
							&& ((texTriangleY[int_33] & 0xFFFF) == trianglePointsY[int_32])
							&& ((texTriangleZ[int_33] & 0xFFFF) == trianglePointsZ[int_32])) {
	...
	public void method986(final int int_0, final int int_1, final int int_2) {
	...
	void decodeNewFormat(final byte[] bytes_0) {
		...
		for (int_44 = 0; int_44 < int_2; int_44++) {
			...
			if (int_45 == 1) {
				texTriangleX[int_44] = (short) buffer_1.readUnsignedShort();
				texTriangleY[int_44] = (short) buffer_1.readUnsignedShort();
				texTriangleZ[int_44] = (short) buffer_1.readUnsignedShort();
				aShortArray12[int_44] = (short) buffer_2.readUnsignedShort();
				aShortArray13[int_44] = (short) buffer_2.readUnsignedShort();
				aShortArray14[int_44] = (short) buffer_2.readUnsignedShort();
				aShortArray15[int_44] = (short) buffer_3.readUnsignedShort();
				aByteArray28[int_44] = buffer_4.readByte();
				aShortArray16[int_44] = (short) buffer_5.readUnsignedShort();
			}
			...
			if (int_45 == 2) {
				...
				aByteArray28[int_44] = buffer_4.readByte();
				aShortArray16[int_44] = (short) buffer_5.readUnsignedShort();
				texturePrimaryColor[int_44] = (short) buffer_5.readUnsignedShort();
			}
	...
	public final Model light(final int int_0, final int int_1, final int int_2, final int int_3, final int int_4) {
		computeNormals();
		...
		model_0.anIntArray130 = new int[triangleFaceCount];
		model_0.anIntArray132 = new int[triangleFaceCount];
		model_0.anIntArray131 = new int[triangleFaceCount];
		if ((anInt615 > 0) && (textureCoords != null)) {
			final int[] ints_0 = new int[anInt615];
			...
			for (int_7 = 0; int_7 < anInt615; int_7++) {
				if ((ints_0[int_7] > 0) && (textureRenderTypes[int_7] == 0)) {
					++model_0.anInt600;
				}
			}

			model_0.anIntArray133 = new int[model_0.anInt600];
			model_0.anIntArray134 = new int[model_0.anInt600];
			model_0.anIntArray135 = new int[model_0.anInt600];
			int_7 = 0;

			int int_9;
			for (int_9 = 0; int_9 < anInt615; int_9++) {
				if ((ints_0[int_9] > 0) && (textureRenderTypes[int_9] == 0)) {
					model_0.anIntArray133[int_7] = texTriangleX[int_9] & 0xFFFF;
					model_0.anIntArray134[int_7] = texTriangleY[int_9] & 0xFFFF;
					model_0.anIntArray135[int_7] = texTriangleZ[int_9] & 0xFFFF;
					ints_0[int_9] = int_7++;
				} else {
					ints_0[int_9] = -1;
				}
			...
			model_0.aByteArray26 = new byte[triangleFaceCount];

			for (int_9 = 0; int_9 < triangleFaceCount; int_9++) {
				if (textureCoords[int_9] != -1) {
					model_0.aByteArray26[int_9] = (byte) ints_0[textureCoords[int_9] & 0xFF];
				} else {
					model_0.aByteArray26[int_9] = -1;
				}
			}
		}
			...
			if (short_0 == -1) {
				if (byte_0 != 0) {
					if (byte_0 == 1) {
						...
						int_11 = (((int_4 * facenormal_0.anInt236) + (int_3 * facenormal_0.anInt237)
								+ (int_2 * facenormal_0.anInt238)) / (int_6 + (int_6 / 2))) + int_0;
						model_0.anIntArray130[int_8] = method998(faceColor[int_8] & 0xFFFF, int_11);
						model_0.anIntArray131[int_8] = -1;
					} else if (byte_0 == 3) {
						model_0.anIntArray130[int_8] = 128;
						model_0.anIntArray131[int_8] = -1;
					} else {
						model_0.anIntArray131[int_8] = -2;
					}
				} else {
					final int int_10 = faceColor[int_8] & 0xFFFF;
					if ((aVertexNormalArray1 != null) && (aVertexNormalArray1[trianglePointsX[int_8]] != null)) {
						vertexnormal_0 = aVertexNormalArray1[trianglePointsX[int_8]];
					} else {
						vertexnormal_0 = normals[trianglePointsX[int_8]];
					}

					int_11 = (((int_4 * vertexnormal_0.anInt198) + (int_2 * vertexnormal_0.anInt196)
							+ (int_3 * vertexnormal_0.anInt197)) / (int_6 * vertexnormal_0.magnitude)) + int_0;
					model_0.anIntArray130[int_8] = method998(int_10, int_11);
					if ((aVertexNormalArray1 != null) && (aVertexNormalArray1[trianglePointsY[int_8]] != null)) {
						vertexnormal_0 = aVertexNormalArray1[trianglePointsY[int_8]];
					} else {
						vertexnormal_0 = normals[trianglePointsY[int_8]];
					}

					int_11 = (((int_2 * vertexnormal_0.anInt196) + (int_3 * vertexnormal_0.anInt197)
							+ (int_4 * vertexnormal_0.anInt198)) / (int_6 * vertexnormal_0.magnitude)) + int_0;
					model_0.anIntArray132[int_8] = method998(int_10, int_11);
					if ((aVertexNormalArray1 != null) && (aVertexNormalArray1[trianglePointsZ[int_8]] != null)) {
						vertexnormal_0 = aVertexNormalArray1[trianglePointsZ[int_8]];
					} else {
						vertexnormal_0 = normals[trianglePointsZ[int_8]];
					}

					int_11 = (((int_3 * vertexnormal_0.anInt197) + (int_2 * vertexnormal_0.anInt196)
							+ (int_4 * vertexnormal_0.anInt198)) / (int_6 * vertexnormal_0.magnitude)) + int_0;
					model_0.anIntArray131[int_8] = method998(int_10, int_11);
				}
			} else if (byte_0 != 0) {
				if (byte_0 == 1) {
					facenormal_0 = faceNormals[int_8];
					int_11 = (((int_4 * facenormal_0.anInt236) + (int_2 * facenormal_0.anInt238)
							+ (int_3 * facenormal_0.anInt237)) / (int_6 + (int_6 / 2))) + int_0;
					model_0.anIntArray130[int_8] = method997(int_11);
					model_0.anIntArray131[int_8] = -1;
				} else {
					model_0.anIntArray131[int_8] = -2;
				}
				...
				int_11 = (((int_4 * vertexnormal_0.anInt198) + (int_3 * vertexnormal_0.anInt197)
						+ (int_2 * vertexnormal_0.anInt196)) / (int_6 * vertexnormal_0.magnitude)) + int_0;
				model_0.anIntArray130[int_8] = method997(int_11);
				if ((aVertexNormalArray1 != null) && (aVertexNormalArray1[trianglePointsY[int_8]] != null)) {
					vertexnormal_0 = aVertexNormalArray1[trianglePointsY[int_8]];
				} else {
				...
				int_11 = (((int_2 * vertexnormal_0.anInt196) + (int_3 * vertexnormal_0.anInt197)
						+ (int_4 * vertexnormal_0.anInt198)) / (int_6 * vertexnormal_0.magnitude)) + int_0;
				model_0.anIntArray132[int_8] = method997(int_11);
				if ((aVertexNormalArray1 != null) && (aVertexNormalArray1[trianglePointsZ[int_8]] != null)) {
					vertexnormal_0 = aVertexNormalArray1[trianglePointsZ[int_8]];
				} else {
					vertexnormal_0 = normals[trianglePointsZ[int_8]];
				...
				int_11 = (((int_4 * vertexnormal_0.anInt198) + (int_3 * vertexnormal_0.anInt197)
						+ (int_2 * vertexnormal_0.anInt196)) / (int_6 * vertexnormal_0.magnitude)) + int_0;
				model_0.anIntArray131[int_8] = method997(int_11);
			}
		}

		computeAnimationTables();
		model_0.anInt596 = vertexCount;
		model_0.verticesX = vertexX;
		model_0.verticesY = vertexY;
		model_0.verticesZ = vertexZ;
		model_0.anInt598 = triangleFaceCount;
		model_0.indices1 = trianglePointsX;
		model_0.indices2 = trianglePointsY;
		model_0.indices3 = trianglePointsZ;
		model_0.aByteArray25 = faceRenderPriorities;
		model_0.aByteArray24 = faceAlphas;
		model_0.aByte5 = priority;
		model_0.anIntArrayArray17 = anIntArrayArray19;
		model_0.anIntArrayArray18 = anIntArrayArray20;
		model_0.aShortArray11 = faceTextures;
		return model_0;
	}

	public void method987(final int int_0, final int int_1, final int int_2) {
		for (int int_3 = 0; int_3 < vertexCount; int_3++) {
			vertexX[int_3] += int_0;
			vertexY[int_3] += int_1;
			vertexZ[int_3] += int_2;
	...
	public ModelData method988(final int[][] ints_0, final int int_0, final int int_1, final int int_2,
			final boolean bool_0, final int int_3) {
		method982();
		int int_4 = int_0 + anInt610;
		int int_5 = int_0 + anInt611;
		int int_6 = int_2 + anInt613;
		int int_7 = int_2 + anInt614;
			...
			if ((int_1 == ints_0[int_4][int_6]) && (int_1 == ints_0[int_5][int_6]) && (int_1 == ints_0[int_4][int_7])
				...
				if (int_3 == 0) {
					for (int_8 = 0; int_8 < modeldata_1.vertexCount; int_8++) {
						...
						int_16 = ((int_11 * ints_0[int_13 + 1][int_14 + 1])
					...
					for (int_8 = 0; int_8 < modeldata_1.vertexCount; int_8++) {
						...
						if (int_9 < int_3) {
							...
							int_17 = ((ints_0[int_14 + 1][int_15 + 1] * int_12)
									+ (ints_0[int_14][int_15 + 1] * (128 - int_12))) >> 7;
							final int int_18 = ((int_16 * (128 - int_13)) + (int_17 * int_13)) >> 7;
							modeldata_1.vertexY[int_8] = (((int_18 - int_1) * (int_3 - int_9)) / int_3)
									+ vertexY[int_8];
						}
					}
				}

				modeldata_1.method983();
				return modeldata_1;
			}
		} else {
			return this;
	...
	void computeAnimationTables() {
		...
		if (triangleSkinValues != null) {
			...
			for (int_1 = 0; int_1 < triangleFaceCount; anIntArrayArray20[int_2][ints_0[int_2]++] = int_1++) {
				int_2 = triangleSkinValues[int_1];
			}
	...
	public void method990(final int int_0) {
		final int int_1 = anIntArray137[int_0];
		final int int_2 = anIntArray139[int_0];
	...
	final int method994(final ModelData modeldata_1, final int int_0) {
		int int_1 = -1;
	...
	public static ModelData method995(final IndexDataBase indexdatabase_0, final int int_0, final int int_1) {
		final byte[] bytes_0 = indexdatabase_0.getConfigData(int_0, int_1);
		return bytes_0 == null ? null : new ModelData(bytes_0);
	}

	static void method996(final ModelData modeldata_0, final ModelData modeldata_1, final int int_0, final int int_1,
			final int int_2, final boolean bool_0) {
		modeldata_0.method982();
		modeldata_0.computeNormals();
		modeldata_1.method982();
		...
		for (int_5 = 0; int_5 < modeldata_0.vertexCount; int_5++) {
			...
			if (vertexnormal_0.magnitude != 0) {
				...
				if (int_6 <= modeldata_1.anInt612) {
					final int int_7 = modeldata_0.vertexX[int_5] - int_0;
					if ((int_7 >= modeldata_1.anInt610) && (int_7 <= modeldata_1.anInt611)) {
						final int int_8 = modeldata_0.vertexZ[int_5] - int_2;
						if ((int_8 >= modeldata_1.anInt613) && (int_8 <= modeldata_1.anInt614)) {
							for (int int_9 = 0; int_9 < int_4; int_9++) {
								...
								if ((int_7 == ints_0[int_9]) && (int_8 == modeldata_1.vertexZ[int_9])
									...
									vertexnormal_2.anInt196 += vertexnormal_1.anInt196;
									vertexnormal_2.anInt197 += vertexnormal_1.anInt197;
									vertexnormal_2.anInt198 += vertexnormal_1.anInt198;
									vertexnormal_2.magnitude += vertexnormal_1.magnitude;
									vertexnormal_3.anInt196 += vertexnormal_0.anInt196;
									vertexnormal_3.anInt197 += vertexnormal_0.anInt197;
									vertexnormal_3.anInt198 += vertexnormal_0.anInt198;
									vertexnormal_3.magnitude += vertexnormal_0.magnitude;
									++int_3;
									anIntArray138[int_5] = anInt609;
									anIntArray140[int_9] = anInt609;
								}
							}
						}
					}
		...
		if (int_3 >= 3) {
			if (bool_0) {
				for (int_5 = 0; int_5 < modeldata_0.triangleFaceCount; int_5++) {
					if ((anIntArray138[modeldata_0.trianglePointsX[int_5]] == anInt609)
							&& (anIntArray138[modeldata_0.trianglePointsY[int_5]] == anInt609)
							&& (anIntArray138[modeldata_0.trianglePointsZ[int_5]] == anInt609)) {
				...
				for (int_5 = 0; int_5 < modeldata_1.triangleFaceCount; int_5++) {
					if ((anInt609 == anIntArray140[modeldata_1.trianglePointsX[int_5]])
							&& (anInt609 == anIntArray140[modeldata_1.trianglePointsY[int_5]])
							&& (anInt609 == anIntArray140[modeldata_1.trianglePointsZ[int_5]])) {
	...
	static final int method997(int int_0) {
		if (int_0 < 2) {
			int_0 = 2;
		} else if (int_0 > 126) {
			int_0 = 126;
	...
	static final int method998(final int int_0, int int_1) {
